...
public class VanyaActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_vanya);
        ...
        if (btnOrder != null) {
            btnOrder.setOnClickListener(v -> {
                if (isUserLoggedIn()) {
                    Intent intent = new Intent(VanyaActivity.this, zakazvanya.class);
    ...
    public void showBookingDialog(View view) {
        ...
        btnConfirm.setOnClickListener(v -> {
            ...
            if (guests > 15) {
                ...
                lastOrderId = dbHelper.insertOrder(currentUser, "Дядя ВАНЯ", "Бронирование", details);
