    ...
    public void showBookingDialog(View view) {
        ...
        btnConfirm.setOnClickListener(v -> {
            ...
            if (guests > 15) {
                ...
                // Сохраняем и запоминаем ID бронирования
                lastOrderId = dbHelper.insertOrder(currentUser, "Гоголь-Моголь", "Бронирование", details);
    ...
    private void showPreOrderPrompt(String bookingDetails) {
        new AlertDialog.Builder(this)
                ...
                .setPositiveButton("Да, выбрать блюда", (dialog, which) -> {
                    Intent intent = new Intent(gogolactivity.this, MENUGOGOL.class);
                    // Передаем ID существующего заказа и детали брони
